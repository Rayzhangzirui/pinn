...
# paths
model_name = "mri2d_st_noise_linear"
...
# [t x y phi pwm pgm u]
INVERSE = True
inv_dat_file = '/home/ziruz16/pinn/data/datmri_dim2_n20000_st1_linear.txt'
...
pwm = dat[:,DIM+1:DIM+2]
pgm = dat[:,DIM+2:DIM+3]
udat = dat[:,-1::] + tf.random.normal([Nres,1], 0, 0.1, DTYPE)

test_dat_file = '/home/ziruz16/pinn/data/datmri_dim2_n20000_st0_linear.txt'
