#!/usr/bin/env python
# restrict udat with noise to positive
...
# prepare data
n = hp["n_res_pts"]
inv_dat_file = '/home/ziruz16/pinn/data/datmri_dim2_n40000_st1_linear.mat'
xdat, udato, phi, pwm, pgm = read_mri_dat(n,inv_dat_file,DIM)
...
test_dat_file = '/home/ziruz16/pinn/data/datmri_dim2_n40000_st0_linear.mat'
xtest, utest, _, _, _ = read_mri_dat(n,test_dat_file,DIM)

bound = np.amax(rdat) # domain boundary[mm], maximum radius


udat = udato + np.random.normal(0, sigma, (n,1))
udat[udat<0]=0
