...
# [t x y phi pwm pgm u]
INVERSE = True
inv_dat_file = '/home/ziruz16/pinn/data/datmri_dim3_n20000_st0_linear.txt'
dat = tf.convert_to_tensor(np.loadtxt(inv_dat_file,delimiter=','),dtype=DTYPE)
xdat = dat[:,0:DIM]/scale
phi = dat[:,DIM:DIM+1]
pwm = dat[:,DIM+1:DIM+2]
pgm = dat[:,DIM+2:DIM+3]
udat = dat[:,-1::]
...
test_dat_file = '/home/ziruz16/pinn/data/datmri_dim3_n20000_st0_linear.txt'
